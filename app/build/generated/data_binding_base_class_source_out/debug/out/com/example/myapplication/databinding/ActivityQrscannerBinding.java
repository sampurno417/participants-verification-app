...
public final class ActivityQrscannerBinding implements ViewBinding {
  ...
  private ActivityQrscannerBinding(@NonNull LinearLayout rootView,
      @NonNull CompoundBarcodeView barcodeScanner) {
  ...
  public static ActivityQrscannerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      CompoundBarcodeView barcodeScanner = ViewBindings.findChildViewById(rootView, id);
      if (barcodeScanner == null) {
        break missingId;
      }

      return new ActivityQrscannerBinding((LinearLayout) rootView, barcodeScanner);
    }
